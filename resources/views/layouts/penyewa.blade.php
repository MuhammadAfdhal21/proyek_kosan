...
<body>
    <div class="sidebar d-flex flex-column">
        ...
        <ul class="nav flex-column px-3">
            ...
            <li class="nav-item">
                <a href="{{ route('penyewa.kost.index') }}" class="nav-link {{ request()->routeIs('penyewa.kost.index') ? 'active' : '' }}">
                    <i class="bi bi-search me-2"></i> Cari Kost
                </a>
            </li>
            <li class="nav-item">
                <a href="{{ route('penyewa.riwayat') }}" class="nav-link {{ request()->routeIs('penyewa.riwayat') ? 'active' : '' }}">
